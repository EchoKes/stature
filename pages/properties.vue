<template>
  ...
  <div class="p-4 pt-12 pb-10 bg-white">
    <h1 class="text-5xl text-black font-bold text-center my-12" data-aos="fade-up">
      Properties Managed
    </h1>
    ...
    <!-- Grid of Cards -->
    <div
      class="xl:mx-14 sm:mx-2 md:mx-6 lg:mx-8 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-10"
    >
      <div
      ...
      >
        <figure>
          <img :src="property.image" :alt="property.name" class="h-72 w-full object-cover" />
        </figure>
        <div
          class="card-body px-4 py-3 bg-gradient-to-r from-indigo-500/10 to-teal-400/10 rounded-b-xl"
        >
          ...
          <div class="mt-2 flex justify items-center">
            ...
            <div>&nbsp;</div>
            <div class="badge badge-primary text-white font-medium">{{ property.units }} Units</div>
          </div>
        </div>
      </div>
    </div>
      ...
      <div class="modal-box max-w-4xl bg-white text-black p-0">
        ...
        <div class="p-6">
          ...
          <p
            ...
            v-html="modalProperty?.description"
          ></p>
          <div class="flex mt-4">
...
<script setup>
useHead({
  title: "Projects | Stature Real Estate",
  meta: [
    {
      name: "description",
      content:
        "Explore Stature Real Estate's property portfolio, including residential, commercial, and industrial projects we manage.",
    },
    { name: "author", content: "Stature Real Estate" },

    { property: "og:title", content: "Our Properties | Stature Real Estate" },
    {
      property: "og:description",
      content:
        "Browse our portfolio of residential, commercial, and industrial properties managed by Stature Real Estate.",
    },
    { property: "og:image", content: "/images/stature-logo.svg" },
    { property: "og:url", content: "https://stature.com.sg/properties" },
...
const filteredProperties = computed(() => {
  ...
  return properties.value.filter(
    (p) => p.region?.trim().toLowerCase() === selectedRegion.value.toLowerCase()
  );
});
